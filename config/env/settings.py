...
class Settings(BaseSettings):
    ...
    sqlite_path: str = Field(default="data/generated/kb.sqlite3", alias="SQLITE_PATH")
    ...
    docs_base_url: str = Field(default="https://tgtaps.gitbook.io/tgtaps-docs", alias="DOCS_BASE_URL")
